BOT_TOKEN = "5267029264:AAECuE7tvtkY2bHhXTDPVskEqaqMEQxzcz8"
RESULTS_COUNT = 4  # NOTE Number of results to show, 4 is better
SUDO_CHATS_ID = [-1001785091746]


DRIVE_NAME = [
    "Kurslab",  # folder 1 name
    "Kurslab",  # folder 2 name
...
DRIVE_ID = [
    "1w2Bk_YusnY3Koka1HhI2imtHd8G0rm-8",  # folder 1 id
    "1w2Bk_YusnY3Koka1HhI2imtHd8G0rm-8",  # folder 2 id
...
INDEX_URL = [
    "https://kurslab.ml/1:/",  # folder 1 index link
    "https://kurslab.ml/1:/",  # folder 2 index link
